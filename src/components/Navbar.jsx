...
function Navbar() {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium hover:cursor-pointer'>
      ...
      <div className='flex items-center gap-6'>
        <img src={assets.search_icon} className='w-5 curston-pointer' alt='search-bar' onClick={()=>setShowSearch(true)} />

        <div className='group relative'>
            <Link to={'/login'}><img  src={assets.profile_icon} className='w-5 curston-pointer' /></Link>
